...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        intermediateOut, cache1 = affine_relu_forward(X,W1,b1)
        scores, cache2 = affine_forward(intermediateOut, W2, b2)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for index in range(len(hidden_dims) + 1):
            ...
            layerInputDimension = input_dim if index == 0 else hidden_dims[index - 1]
